...
//slingShot =new SlingShot (circle1.body,{x:130,y:200})
	...
	//Create a Ground
	ground2 = new Ground(680,400,230,20)
	box17=new Box(610,370,30,40)

	box18=new Box(640,370,30,40)
	box19=new Box(670,370,30,40)
	box20=new Box(600,370,30,40)
	box21=new Box(730,370,30,40)
	box22=new Box(760,370,30,40)
	box23=new Box(790,370,30,40)
	box24=new Box(640,330,30,40)
	box25=new Box(670,330,30,40)
	box26=new Box(700,330,30,40)
	box27=new Box(730,330,30,40)
	box28=new Box(660,330,30,40)
	box29=new Box(670,290,30,40)
	box30=new Box(700,290,30,40)
	box31=new Box(730,290,30,40)
	box32=new Box(700,250,30,40)
